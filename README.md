<p align="center" ><img class="aligncenter" src="https://github.com/d0ubletr0uble/DataNet/raw/master/icon.png" alt="" width="180" height="113" /></p>
...
<h3 id="upload_image-parameters">Parameters</h3>

|Name|In| Type                                                                  |Required|Description|
|---|---|-----------------------------------------------------------------------|---|---|
|body|body| [Body_upload_image](#schemabody_upload_image_upload_postupload_image) |true|none|
...
<h3 id="upload_image-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Successful Response|[UploadSummary](#schemauploadsummary)|
...
## find users data by json data

<a id="opIdsearch_by_json"></a>
...
takes any json as request body
...
```json
{
  "users": [
    {
      "_id": "432274227563069451",
      "name": "John Smith",
      "age": 20
    },
    {
      "_id": "562627439967832726",
      "type": "student",
      "modules": [
        "P1456235",
        "P1655578"
...
<h3 id="search_by_json-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Successful Response|[UsersResponse](#schemausersresponse)|
...
<h3 id="upload_user_data-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[FaceList](#schemafacelist)|true|none|
...
<h3 id="upload_user_data-responses">Responses</h3>
...
<h3 id="upload_user_data-responseschema">Response Schema</h3>
...
<h3 id="edit_user_data-parameters">Parameters</h3>
...
<h3 id="edit_user_data-responses">Responses</h3>
...
<h3 id="edit_user_data-responseschema">Response Schema</h3>
...
<h3 id="find_by_face-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[FindInput](#schemafindinput)|true|none|
...
<h3 id="find_by_face-responses">Responses</h3>
...
<h3 id="find_by_face-responseschema">Response Schema</h3>
...
<h3 id="assign_by_face-parameters">Parameters</h3>

|Name|In| Type                                                                          |Required|Description|
|---|---|-------------------------------------------------------------------------------|---|---|
|body|body| [Body_assign_by_face](#schemabody_upload_users_batch_edit_postassign_by_face) |true|none|
...
<h3 id="assign_by_face-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Successful Response|[BatchEditResponse](#schemabatcheditresponse)|
|422|[Unprocessable Entity](https://tools.ietf.org/html/rfc2518#section-10.3)|Validation Error|[HTTPValidationError](#schemahttpvalidationerror)|
...
<h2 id="tocS_BatchEditResponse">BatchEditResponse</h2>
<!-- backwards compatibility -->
<a id="schemabatcheditresponse"></a>
<a id="schema_BatchEditResponse"></a>
<a id="tocSbatcheditresponse"></a>
<a id="tocsbatcheditresponse"></a>
...
<h2 id="tocS_Body_upload_image">Body_upload_image</h2>
<!-- backwards compatibility -->
<a id="schemabody_upload_image"></a>
<a id="schema_Body_upload_image"></a>
<a id="tocSbody_upload_image"></a>
<a id="tocsbody_upload_image"></a>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|image|string|true|none|base64 encoded bytes of image|

<h2 id="tocS_Body_assign_by_face">Body_assign_by_face</h2>
<!-- backwards compatibility -->
<a id="schemabody_assign_by_face"></a>
<a id="schema_Body_assign_by_face"></a>
<a id="tocSbody_assign_by_face"></a>
<a id="tocsbody_assign_by_face"></a>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|image|string|true|none|base64 encoded image bytes|
|data|string|true|none|json data|

<h2 id="tocS_FaceInput">FaceInput</h2>
<!-- backwards compatibility -->
<a id="schemafaceinput"></a>
<a id="schema_FaceInput"></a>
<a id="tocSfaceinput"></a>
<a id="tocsfaceinput"></a>
...
<h2 id="tocS_FaceList">FaceList</h2>
<!-- backwards compatibility -->
<a id="schemafacelist"></a>
<a id="schema_FaceList"></a>
<a id="tocSfacelist"></a>
<a id="tocsfacelist"></a>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|faces|[[FaceInput](#schemafaceinput)]|true|none|none|

<h2 id="tocS_FaceSummary">FaceSummary</h2>
<!-- backwards compatibility -->
<a id="schemafacesummary"></a>
<a id="schema_FaceSummary"></a>
<a id="tocSfacesummary"></a>
<a id="tocsfacesummary"></a>
...
<h2 id="tocS_FindInput">FindInput</h2>
<!-- backwards compatibility -->
<a id="schemafindinput"></a>
<a id="schema_FindInput"></a>
<a id="tocSfindinput"></a>
<a id="tocsfindinput"></a>
...
<h2 id="tocS_UploadSummary">UploadSummary</h2>
<!-- backwards compatibility -->
<a id="schemauploadsummary"></a>
<a id="schema_UploadSummary"></a>
<a id="tocSuploadsummary"></a>
<a id="tocsuploadsummary"></a>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|faces|[[FaceSummary](#schemafacesummary)]|false|none|none|
